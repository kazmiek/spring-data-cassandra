...
import org.springframework.cassandra.core.CqlOperationsNG;
 ...
 * @since 2.0
 */
public class CassandraTemplateNG implements CassandraOperationsNG {

	private final CassandraConverter converter;
	private final CassandraMappingContext mappingContext;
	private final CqlOperationsNG cqlOperations;

	/**
	 * Creates an instance of {@link CassandraTemplateNG} initialized with the given {@link Session} and
	 ...
	 * @see Session
	 */
	public CassandraTemplateNG(Session session, CassandraConverter converter) {
		...
		this.cqlOperations = new CqlTemplateNG(session);
	}

	/**
	 * Creates an instance of {@link CassandraTemplateNG} initialized with the given {@link CqlOperationsNG} and
	 * {@link CassandraConverter}.
	 *
	 * @param cqlOperations {@link CqlOperationsNG} used to interact with Cassandra; must not be {@literal null}.
	 * @param converter {@link CassandraConverter} used to convert between Java and Cassandra types; must not be
	 *          {@literal null}.
	 * @see CassandraConverter
	 * @see Session
	 */
	public CassandraTemplateNG(CqlOperationsNG cqlOperations, CassandraConverter converter) {
