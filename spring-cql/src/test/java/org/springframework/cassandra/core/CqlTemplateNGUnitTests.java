...
public class CqlTemplateNGUnitTests {
	...
	public void setup() {
		...
		this.template = new CqlTemplateNG();
	...
	private <T> void doTestStrings(Integer fetchSize, ConsistencyLevel consistencyLevel,
			com.datastax.driver.core.policies.RetryPolicy retryPolicy, Consumer<CqlTemplateNG> cqlTemplateConsumer) {
		...
		CqlTemplateNG template = new CqlTemplateNG();
