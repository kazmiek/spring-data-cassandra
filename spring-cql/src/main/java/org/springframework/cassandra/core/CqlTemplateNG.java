 ...
 */
public class CqlTemplateNG extends CassandraAccessor implements CqlOperationsNG {
	...
	/**
	 * Construct a new {@link CqlTemplateNG}. Note: The {@link Session} has to be set before using the instance.
	 *
	 * @see #setSession(Session)
	 */
	public CqlTemplateNG() {}

	/**
	 * Construct a new {@link CqlTemplateNG}, given a {@link Session}.
	 *
	 * @param session the active Cassandra {@link Session}.
	 */
	public CqlTemplateNG(Session session) {
